...
public class setProfile extends AppCompatActivity {
    ...
    ProgressBar mprogessbarofsetprofile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mprogessbarofsetprofile=findViewById(R.id.progressbarSaveProfile);
        ...
        msaveprofile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    mprogessbarofsetprofile.setVisibility(View.VISIBLE);
                    sendDataForNewUser();
                    mprogessbarofsetprofile.setVisibility(View.INVISIBLE);
    ...
    private void sendDataTocloudfireStore() {
        ...
        documentReference.set(userdata).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(getApplicationContext(),"Data on Cloud FireStore send Successfully ",Toast.LENGTH_SHORT).show();
